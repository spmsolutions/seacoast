...
export function WindowObject(props) {
  ...
  return (
    <>
      <h3>Usage</h3>
      <p>
        To access {name} object and all its customization options use your
        browsers console and type:
      </p>
      ...
      {url && (
        <p>
          You can find all methods and their documentation on this{" "}
